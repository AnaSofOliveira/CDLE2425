...
function usage() {
	...
	echo ""
	echo "Where <Number of Reducers> is the number of reducers to use"
	exit
}
...
ARGS="${INPUT_DIRECTORY} ${OUTPUT_DIRECTORY} -D mapreduce.job.reduces=${NUMBER_REDUCERS}"
