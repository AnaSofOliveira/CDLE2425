...
public class WordCountApplication extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		try{
			...
			System.out.println("Dados copiados com sucesso do filesystem local: " + args[0] + " para o filesystem do HDFS: " + args[1]);
			return 1;
		} catch (Exception e) {
			System.out.println("Erro ao copiar do filesystem local: " + args[0] + " para o filesystem do HDFS: " + args[1]);
			return 0;
		}
	}
